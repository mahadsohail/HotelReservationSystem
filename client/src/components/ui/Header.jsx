...
export const Header = () => {
  ...
  return (
    <header
      className={`fixed top-0 z-10 flex w-screen justify-center bg-gradient-to-l from-amber-700 via-gray-400 to-gray-50 py-4 ${
        hasShadow ? 'shadow-md' : ''
      }`}
    >
      <div
      ...
      >
        <a href="/" className="flex items-center gap-1">
          ...
          <span className="hidden text-2xl font-bold text-amber-700 md:block font-sans">
            StaySure
          </span>
        </a>
